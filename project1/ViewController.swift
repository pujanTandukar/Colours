...
class ViewController: UIViewController {
    ...
    //Saving the hex values to clipboard
    @IBAction func secondButtonPress(_ sender: Any) {
        UIPasteboard.general.string = button2.titleLabel?.text
    }
    
    @IBAction func firstButtonPress(_ sender: Any) {
        UIPasteboard.general.string = button1.titleLabel?.text
    }
    
    @IBAction func thirdButtonPress(_ sender: Any) {
        UIPasteboard.general.string = button3.titleLabel?.text
    }
    
    @IBAction func fourthButtonPress(_ sender: Any) {
        UIPasteboard.general.string = button4.titleLabel?.text
    }
    
    @IBAction func lastButtonPress(_ sender: Any) {
        UIPasteboard.general.string = button5.titleLabel?.text
    }
...
//    }
    ...
    func animateButton() {
        ...
        UIView.animate(withDuration: 1.0, //duration of the animation
            delay: 0,
            usingSpringWithDamping: CGFloat(0.7), //wobbliness of the button
            initialSpringVelocity: CGFloat(2.0), //initial speed of the button
        ...
        UIView.animate(withDuration: 1.0, //duration of the animation
            delay: 0.15,
            usingSpringWithDamping: CGFloat(0.75), //wobbiness of the button
            initialSpringVelocity: CGFloat(2.0), //initial speed of the button
            options: .allowUserInteraction,
        ...
        UIView.animate(withDuration: 1.0, //duration of the animation
            delay: 0.30,
            usingSpringWithDamping: CGFloat(0.80), //wobbiness of the button
            initialSpringVelocity: CGFloat(2.0), //initial speed of the button
            options: .allowUserInteraction,
        ...
        UIView.animate(withDuration: 1.0, //duration of the animation
            delay: 0.45,
            usingSpringWithDamping: CGFloat(0.9), //wobbiness of the button
            initialSpringVelocity: CGFloat(2.0), //initial speed of the button
            options: .allowUserInteraction,
        ...
        UIView.animate(withDuration: 1.0, //duration of the animation
            delay: 0.60,
            usingSpringWithDamping: CGFloat(0.95), //wobbiness of the button
            initialSpringVelocity: CGFloat(2.0), //initial speed of the button
            options: .allowUserInteraction,
